...
I am interested in generative models, including LLMs, diffusion models, and alignment (RLHF). Recently, I am researching on (1) scalable methods for aligning diffusion models from a continuous-time perspective, leveraging tools from stochastic control and continuous-time RL (2) a new pipeline for formulating perference pairs, leading to explainable, personalized and effective alignment of generative models.